...
public class Inlogg extends javax.swing.JFrame {
    ...
    private InfDB idb;
    private static String userLosen;
    ...
    private void buttonLogOnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonLogOnActionPerformed
        ...
        if (Validering.textFaltHarVarde(fieldName) && Validering.textFaltHarVarde(fieldPW)){
            try{
                ...
                isAdmin = idb.fetchSingle("Select Administrator FROM agent WHERE Agent_ID =" + svarID);
                ...
                if (losenordTva.equals(losenord)){
                    ...
                    else if(val == 0 && isAdmin.equals("J")){
    ...
    public static String getUserLosen(){
        return userLosen;
    }
    
    public static boolean getVal(){
        boolean kategori = true;
        if(val == 1)
            kategori = false;
